...
/**
 * Entrada imutável no Event Store do wallet-service.
 *
 ...
 * replay temporal e queries ad-hoc para auditoria e compliance financeiro.</p>
 *
 * <p><strong>Não confundir com {@link OutboxMessage}:</strong> o outbox é um
 * relay temporário para o broker; o Event Store é o registro permanente e imutável
 * de todos os eventos de domínio do wallet-service.</p>
 *
 * <p>Mesma estratégia utilizada no order-service — consistência arquitetural
 * entre microsserviços para auditoria financeira completa.</p>
 */
@Entity
...
public class EventStoreEntry {
    ...
    /** Tipo do evento (ex: "FundsReservedEvent"). */
     ...
     * @param aggregateId   ID do agregado (ex: walletId como String).
