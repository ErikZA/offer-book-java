...
/**
 * Job de limpeza da tabela {@code outbox_message} no wallet-service.
 *
 * <h3>Problema (AT-2.3.1)</h3>
 * <p>Mensagens com {@code processed=true} e mais de {@value #RETENTION_DAYS} dias
 ...
 * performance do índice parcial {@code WHERE processed = FALSE} usado pelo relay.</p>
 *
 * <h3>Política de retenção</h3>
 * <p>Remove apenas mensagens com {@code processed=true AND created_at < now - 7 dias}.
 * Mensagens pendentes ({@code processed=false}) nunca são tocadas — preservar o
...
public class OutboxCleanupJob {
     ...
     */
    public OutboxCleanupJob(OutboxMessageRepository outboxMessageRepository, Clock clock) {
     ...
     *
     * <p>Apenas mensagens com {@code processed=true} são elegíveis para remoção.
