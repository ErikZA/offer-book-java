...
Configuração: [`CircuitBreakerConfig.java`](../../apps/order-service/src/main/java/com/vibranium/orderservice/config/CircuitBreakerConfig.java) + `application.yaml` seção `resilience4j`.
