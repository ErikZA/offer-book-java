...
```bash
# Windows PowerShell
.\scripts\build.ps1 docker-dev-up       # Iniciar dev (hotreload)
.\scripts\build.ps1 docker-test         # Executar testes
.\scripts\build.ps1 docker-prod-up      # Iniciar produção
...
- **[docs/testing/COMPREHENSIVE_TESTING.md](../testing/COMPREHENSIVE_TESTING.md)** - Guia completo com padrões de teste
...
- **[docs/architecture/order-book-mvp.md](../architecture/order-book-mvp.md)** - Arquitetura
- **[docs/PERFORMANCE_REPORT.md](../PERFORMANCE_REPORT.md)** - Relatório de performance (Gatling)
- **[docs/README.md](../README.md)** - Índice completo de documentação
- **[docs/SECRETS_MANAGEMENT.md](../SECRETS_MANAGEMENT.md)** - Gestão de credenciais com Docker Secrets
...
Foi adicionada uma **camada de segurança completa** baseada em Keycloak 22, com importação automática de realm ao subir o ambiente. Todo o estado inicial é declarativo via [`infra/keycloak/realm-export.json`](../../infra/keycloak/realm-export.json):
...
| [`tests/e2e/docker-compose.e2e.yml`](../../tests/e2e/docker-compose.e2e.yml) | Stack E2E isolada (SagaEndToEndIT) |
